...
import { InsightsHeroVisual } from "./InsightsHeroVisual";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-6 lg:py-2 w-full flex-1 flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center w-full">
          ...
          <div className="lg:col-span-6 flex flex-col items-start">
            ...
            >
              <Badge pillar="advisory" dot className="mb-4">
            ...
            >
              ...
              <span>Engineering Strategy · Architecture Without Hype</span>
            </motion.div>
            ...
            >
              Notes on AI, automation, technology strategy, and building better systems — from
              what we&apos;re actually doing with clients and in our own engineering lab.
            </motion.p>
          ...
          {/* Right Column: Article Stack Visual */}
