        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center w-full">
          ...
          <div className="lg:col-span-6 flex flex-col items-start">
            ...
            >
              ...
              <span>Engineering-Led · AI-First Technology Partner</span>
            </motion.div>
            ...
            >
              Nimbrix is an AI-first technology company. We design, build, and operate intelligent
              systems for ambitious organizations — the ones that want to actually use technology,
              not just buy it.
            </motion.p>
          ...
          {/* Right Column: About Nimbrix Core Visual */}
