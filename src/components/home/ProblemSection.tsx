      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="max-w-2xl mb-16">
          ...
          <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl tracking-tight text-white mb-6">
            ...
            <span className="text-[#8A95A3]">more complexity.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#1E2430]">
          {problems.map((p) => (
            <div
              key={p.before}
              className="bg-[#0A0D14] p-8 lg:p-10 group hover:bg-[#0D1018] transition-colors"
            >
              {/* Before */}
              <div className="flex items-center gap-3 mb-6">
                <div className="font-mono text-xs text-[#8A95A3] uppercase tracking-widest px-2.5 py-1 border border-[#1E2430] line-through opacity-60">
                  {p.before}
                </div>
              </div>
